...
<html>
  ...
  <tbody>
			...
			<?php
				...
				$result=$obj->ViewTimetable($_SESSION['depname'],$_SESSION['sem']);
    ...
    <tr>
	<form >
      <td scope="row"><input type="text"  class="form-control " value="<?php echo $row['day'] ;?>" readonly></td>
      <td scope="row"><input type="text" class="form-control " value="<?php echo $row['subjecthour1'] ;?>" readonly></td>
	  <td scope="row"><input type="text" class="form-control " value="<?php echo $row['subjecthour2'] ;?>" readonly></td>
	  <td scope="row"><input type="text" class="form-control " value="<?php echo $row['subjecthour3'] ;?>" readonly></td>
	  <td scope="row"><input type="text" class="form-control " value="<?php echo $row['subjecthour4'] ;?>" readonly></td>
